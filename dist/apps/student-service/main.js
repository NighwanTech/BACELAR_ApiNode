...
const website_module_1 = __webpack_require__(141);
const admin_module_1 = __webpack_require__(190);
...
const student_roll_number_module_1 = __webpack_require__(43);
const exam_admit_card_module_1 = __webpack_require__(46);
const student_attendance_module_1 = __webpack_require__(49);
const exam_greviance_module_1 = __webpack_require__(52);
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'check_student_availability' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
let StudentsService = class StudentsService {
    ...
    async generateRegistrationNumber(forDate) {
    ...
    async changePassword(registrationNo, currentPasswordString, newPasswordString) {
        ...
        try {
            if (login.Password && login.Password.startsWith('$2')) {
                isPasswordValid = await bcrypt.compare(currentPasswordString, login.Password);
            }
        }
        catch {
            isPasswordValid = false;
...
let StudentAcademicController = class StudentAcademicController {
    ...
    async save(data) {
        try {
            return await this.academicService.save(data.studentId, data.qualifications, data.CreatedBy, data.programId, data.programSubjectIds, data.hasSportCertificate);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
...
let StudentAcademicService = class StudentAcademicService {
    ...
    async save(studentId, qualifications, CreatedBy, programId, programSubjectIds, hasSportCertificate) {
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'create_icici_checkout' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StudentPaymentController.prototype, "createIciciCheckout", null);
__decorate([
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'mark_payment_failed' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StudentPaymentController.prototype, "markPaymentFailed", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'sync_razorpay_payment_status' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], StudentPaymentController.prototype, "syncRazorpayPaymentStatus", null);
__decorate([
...
let StudentPaymentService = class StudentPaymentService {
    ...
    async createIciciCheckout(data) {
        ...
        if (!baseUrl) {
            throw new common_1.BadRequestException('ICICI payment URL is not configured. Set ICICI_PAYMENT_URL in the API .env');
        }
        const studentId = Number(data.studentId);
        const feeType = (data.feeType || 'REGISTRATION').toUpperCase();
        const student = await this.loadStudentForPaymentSnapshot(studentId);
        ...
        const amount = feeType === 'EXAMINATION'
            ...
            : Number(feeConfig.registrationFinal);
        if (!amount || amount <= 0) {
            throw new common_1.BadRequestException('Payable fee amount is zero. Use exemption flow instead of ICICI checkout.');
        }
        const existingSuccess = await this.prisma.studentPayment.findFirst({
            where: {
                studentId,
        ...
        redirect.searchParams.set('regNo', String(student.registrationNo || payment.registrationNo || ''));
    ...
    async markPaymentFailed(data) {
        ...
        if (status === 'SUCCESS') {
            throw new common_1.BadRequestException('Cannot mark a successful payment as failed');
        }
    ...
    async syncRazorpayPaymentStatus(data) {
        ...
        if (!payment?.razorpayOrderId) {
            return {
                ...
                message: 'No Razorpay payment attempt found. Please proceed to payment first.',
                payment: null,
            };
        }
        const { client } = this.getRazorpayClient();
        ...
        try {
            ...
            throw new common_1.BadRequestException(`Unable to fetch Razorpay status: ${extractErrorMessage(err)}`);
        }
        ...
        if (paid?.id) {
            const student = await this.loadStudentForPaymentSnapshot(studentId);
            const snapshot = this.buildPaymentSnapshot(student, {
                enrollNo: await this.resolvePaymentEnrollNo(studentId, student, payment.enrollNo),
        ...
        const failed = items.find((p) => String(p?.status || '').toLowerCase() === 'failed');
        if (failed) {
            const reason = String(failed?.error_description || failed?.error_reason || '').trim() ||
        ...
        return {
            syncStatus: 'PENDING',
            message: 'Payment is still pending at Razorpay. If amount was deducted, wait a few minutes and check again — do not pay twice.',
            payment,
        };
    }
...
let ExamLoginService = class ExamLoginService {
    ...
    async getDashboardData(studentId) {
        ...
        const isBEdCourse = String(examForm.courseShortName || '').toUpperCase().includes('B.ED') ||
        ...
        let masterExams = [];
        try {
            masterExams = await this.prisma.examinationDetails.findMany({
                where: { IsDeleted: false, IsActive: true },
        ...
        if (studentExams.length > 0) {
            examForms = studentExams.map((se, idx) => {
            ...
            examForms = masterExams.map((me, idx) => {
...
const common_1 = __webpack_require__(5);
const student_roll_number_controller_1 = __webpack_require__(44);
const student_roll_number_service_1 = __webpack_require__(45);
...
exports.StudentRollNumberModule = StudentRollNumberModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [student_roll_number_service_1.StudentRollNumberService],
    })
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'list_student_roll_numbers' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'generate_student_roll_numbers' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'delete_student_roll_number' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'bulk_delete_student_roll_numbers' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
exports.StudentRollNumberController = StudentRollNumberController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof student_roll_number_service_1.StudentRollNumberService !== "undefined" && student_roll_number_service_1.StudentRollNumberService) === "function" ? _a : Object])
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.StudentRollNumberService = void 0;
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
let StudentRollNumberService = class StudentRollNumberService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    roll() {
        const delegate = this.prisma.studentRollNumber;
        if (!delegate?.findMany) {
            throw new common_1.BadRequestException('Prisma model studentRollNumber not loaded. Run: npx prisma generate && restart student-service. Also create table via prisma/sql/add_student_roll_number.sql');
        }
        return delegate;
    }
    enrollment() {
        const delegate = this.prisma.studentEnrollment;
        if (!delegate?.findMany) {
            throw new common_1.BadRequestException('Prisma model studentEnrollment not loaded. Restart student-service.');
        }
        return delegate;
    }
    toNum(value) {
    ...
    extractAdmissionYear(sessionName) {
    ...
    buildRollNo(collegeCode, admissionYear, programCode, serial) {
    ...
    async resolveCollegeCode() {
        const collegeDelegate = this.prisma.collegeMaster;
        ...
        const active = colleges.find((c) => c.IsActive !== false && c.collegeCode) || colleges.find((c) => c.collegeCode);
    ...
    async loadEnrollments(filters) {
        ...
        const studentIds = Array.isArray(filters.studentIds)
            ? filters.studentIds.map((id) => this.toNum(id)).filter((id) => id != null)
            : [];
        const where = {
            IsDeleted: false,
        ...
        rows = (rows || []).filter((e) => String(e.enrollmentNo || '').trim());
        if (programCategoryId != null) {
            rows = rows.filter((e) => {
                const catId = e.program?.programCategoryId ||
    ...
    async list(filters = {}) {
        ...
        const rows = enrollments
            .map((e) => this.mapListRow(e, rollMap, admissionYear))
    ...
    async nextSerial(collegeCode, admissionYear, programCode) {
    ...
    async generate(payload) {
        ...
        const existing = await this.roll().findMany({
            where: {
                IsDeleted: false,
                admissionYear,
                studentId: { in: mapped.map((m) => m.studentId) },
            },
        });
        const existingByStudent = new Map();
        for (const r of existing)
            existingByStudent.set(Number(r.studentId), r);
        const usedRolls = new Set((await this.roll().findMany({
            where: { IsDeleted: false, admissionYear },
            select: { rollNo: true },
        })).map((r) => String(r.rollNo || '')));
        ...
        for (const [programCode, group] of byProgram.entries()) {
            ...
            for (const row of group) {
                ...
                if (!rollNo || usedRolls.has(rollNo)) {
                    throw new common_1.BadRequestException('Could not generate a unique roll number');
                }
    ...
    async remove(payload) {
        ...
        if (rollId == null) {
            throw new common_1.BadRequestException('rollId is required');
        }
        const existing = await this.roll().findFirst({
            where: { rollId, IsDeleted: false },
        });
        if (!existing) {
            throw new common_1.BadRequestException('Roll number not found');
        }
    ...
    async bulkRemove(payload) {
        const ids = Array.isArray(payload.ids)
            ? payload.ids.map((id) => this.toNum(id)).filter((id) => id != null)
            : [];
        if (!ids.length) {
...
exports.StudentRollNumberService = StudentRollNumberService;
exports.StudentRollNumberService = StudentRollNumberService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof prisma_1.PrismaService !== "undefined" && prisma_1.PrismaService) === "function" ? _a : Object])
], StudentRollNumberService);
...
const common_1 = __webpack_require__(5);
const exam_admit_card_controller_1 = __webpack_require__(47);
const exam_admit_card_service_1 = __webpack_require__(48);
...
exports.ExamAdmitCardModule = ExamAdmitCardModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [exam_admit_card_service_1.ExamAdmitCardService],
    })
], ExamAdmitCardModule);
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'list_exam_admit_cards' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_one_exam_admit_card' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
exports.ExamAdmitCardController = ExamAdmitCardController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof exam_admit_card_service_1.ExamAdmitCardService !== "undefined" && exam_admit_card_service_1.ExamAdmitCardService) === "function" ? _a : Object])
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ExamAdmitCardService = void 0;
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
let ExamAdmitCardService = class ExamAdmitCardService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    studentExam() {
    ...
    roll() {
        return this.prisma.studentRollNumber;
    }
    enrollment() {
        return this.prisma.studentEnrollment;
    }
    examScheme() {
        return this.prisma.examScheme;
    }
    toNum(value) {
        if (value === undefined || value === null || value === '')
            return null;
    ...
    pickRoll(student, exam) {
        const fromExam = String(exam?.rollNo || '').trim();
        const rolls = Array.isArray(student?.studentRollNumbers)
            ? student.studentRollNumbers.filter((row) => row && row.IsDeleted !== true)
            : [];
        const byYear = rolls.find((row) => String(row.admissionYear || '') === String(exam?.session?.admissionSessionName || '').match(/(20\d{2})/)?.[1]);
        const latest = [...rolls].sort((a, b) => Number(b.rollId || 0) - Number(a.rollId || 0))[0];
    ...
    paperLabel(code, name, withCode) {
        const pCode = String(code || '').trim();
        const pName = String(name || '').trim();
        if (pCode && pName)
            return `[${pCode}] ${pName}`;
        if (withCode)
            return String(withCode).trim();
        return pName || pCode || '';
    }
    async schemePaperMap(params) {
        const map = new Map();
        if (!params.examinationDetailId || !params.programId || !params.yearId)
            return map;
        ...
        for (const paper of scheme?.papers || []) {
            if (paper?.paperId)
                map.set(Number(paper.paperId), paper);
        }
        return map;
    }
    mapRow(exam, schemeMap) {
        ...
        const papers = (exam.papers || [])
            .filter((paper) => paper.IsDeleted !== true && paper.isChosen !== false)
            .map((paper) => {
    ...
    async list(query) {
        ...
        if (programId != null)
            enrollmentWhere.programId = programId;
        if (yearId != null)
            enrollmentWhere.yearId = yearId;
        if (semId != null)
            enrollmentWhere.semId = semId;
        ...
        let rows = (enrollments || []).filter((e) => String(e.enrollmentNo || '').trim());
        if (programCategoryId != null) {
            rows = rows.filter((e) => {
                const catId = e.program?.programCategoryId ||
                    e.student?.program?.programCategoryId ||
        ...
        rows = rows.filter((e) => rollByStudent.get(Number(e.studentId))?.rollNo);
        ...
        for (const exam of exams || []) {
            ...
            const e = rows.find((r) => Number(r.studentId) === sid);
            if (e &&
                ...
                const existingMatch = Number(existing.courseId || 0) === Number(e.programId || 0) &&
                    Number(existing.yearId || 0) === Number(e.yearId || 0);
                const nextMatch = Number(exam.courseId || 0) === Number(e.programId || 0) &&
                    Number(exam.yearId || 0) === Number(e.yearId || 0);
        ...
        const uniqueKeys = [
            ...new Set(rows.map((e) => `${examinationDetailId || examByStudent.get(Number(e.studentId))?.examinationDetailId || ''}:${e.programId}:${e.yearId}:${e.semId}`)),
        ];
        for (const key of uniqueKeys) {
            const [exId, pId, yId, sId] = key.split(':');
            schemeCache.set(key, await this.schemePaperMap({
        ...
        let items = rows.map((e) => {
            ...
            if (!mapped.papers?.length) {
                ...
                mapped.papers = schemePapers.map((paper) => ({
                    paperId: paper.paperId || null,
                    subjectName: paper.subjectName || null,
                    paperName: paper.paperName || null,
                    paperCode: paper.paperCode || null,
        ...
        if (academicSessionId != null) {
            items = items.filter((item) => {
                ...
                if (Number.isFinite(rowSessionId))
                    return rowSessionId === academicSessionId;
                return true;
            });
        }
        if (examType) {
            items = items.filter((item) => String(item.examType || '').trim().toLowerCase() === examType);
        }
        if (search) {
            items = items.filter((item) => {
                const hay = [
        ...
        items.sort((a, b) => String(a.studentName || '').localeCompare(String(b.studentName || ''), undefined, {
            sensitivity: 'base',
        }));
        return { total: items.length, items };
    }
    mapEnrollmentRow(e, roll, schemeMap) {
        ...
        return {
            ...
            papers: Array.from(schemeMap.values()).map((paper) => ({
                paperId: paper.paperId || null,
                subjectName: paper.subjectName || null,
                paperName: paper.paperName || null,
                paperCode: paper.paperCode || null,
    ...
    async findOne(studentExamId) {
        ...
        if (!exam)
            throw new common_1.NotFoundException('Exam form not found');
...
exports.ExamAdmitCardService = ExamAdmitCardService;
exports.ExamAdmitCardService = ExamAdmitCardService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof prisma_1.PrismaService !== "undefined" && prisma_1.PrismaService) === "function" ? _a : Object])
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const student_attendance_controller_1 = __webpack_require__(50);
const student_attendance_service_1 = __webpack_require__(51);
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'get_scheme_dates_attendance' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'get_paper_students_attendance' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'save_attendance' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'unlock_attendance' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", void 0)
...
exports.StudentAttendanceController = StudentAttendanceController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof student_attendance_service_1.StudentAttendanceService !== "undefined" && student_attendance_service_1.StudentAttendanceService) === "function" ? _a : Object])
...
let StudentAttendanceService = class StudentAttendanceService {
    ...
    examAttendance() {
        return this.prisma.examAttendance;
    }
    examAttendanceDetail() {
        return this.prisma.examAttendanceDetail;
    }
    parseDate(value) {
        if (!value)
            return null;
    ...
    async getSchemeDates(query) {
        ...
        const schemeWhere = { IsDeleted: false };
        if (academicSessionId)
            schemeWhere.academicSessionId = academicSessionId;
        if (examinationDetailId)
            schemeWhere.examinationDetailId = examinationDetailId;
        if (programId)
            schemeWhere.programId = programId;
        const schemes = await this.prisma.examScheme.findMany({
            where: schemeWhere,
            select: { examSchemeId: true, programId: true },
        });
        const schemeIds = schemes.map((s) => s.examSchemeId);
        if (!schemeIds.length)
            return [];
        const schemeMap = new Map();
        schemes.forEach((s) => schemeMap.set(s.examSchemeId, s));
        const papers = await this.prisma.examSchemePaper.findMany({
            where: {
    ...
    async getPaperDetailsAndStudents(query) {
        ...
        if (!academicSessionId || !examinationDetailId || !programId || !examDateStr) {
            throw new common_1.BadRequestException('Academic session, examination, program, and exam date are required.');
        }
        const targetDate = this.parseDate(examDateStr);
        if (!targetDate) {
            throw new common_1.BadRequestException('Invalid exam date format.');
        }
        const schemes = await this.prisma.examScheme.findMany({
            where: {
                academicSessionId,
        ...
        if (schemeIds.length) {
            ...
            if (examTimeStr)
                paperWhere.examTime = examTimeStr;
            if (shiftStr)
                paperWhere.shift = shiftStr;
            matchedPaper = await this.prisma.examSchemePaper.findFirst({
                where: paperWhere,
            });
            if (!matchedPaper) {
                matchedPaper = await this.prisma.examSchemePaper.findFirst({
        ...
        if (existingAttendance) {
            ...
            return {
                ...
                students: existingAttendance.details.map((d, index) => ({
                    srNo: index + 1,
        ...
        let studentsList = [];
        const rollNumbers = await this.prisma.studentRollNumber.findMany({
            where: {
                IsDeleted: false,
                OR: [
                    { programId },
        ...
        if (rollNumbers.length) {
            studentsList = rollNumbers.map((rn, index) => ({
                srNo: index + 1,
        ...
        if (!studentsList.length) {
            ...
            if (enrollments.length) {
                studentsList = enrollments.map((en, index) => ({
                    srNo: index + 1,
                    attendanceDetailId: null,
        ...
        if (!studentsList.length) {
            ...
            if (examStudents.length) {
                studentsList = examStudents.map((se, index) => ({
                    srNo: index + 1,
                    attendanceDetailId: null,
    ...
    async unlockAttendance(attendanceId, actor = 'Super Admin') {
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const exam_greviance_controller_1 = __webpack_require__(53);
const exam_greviance_service_1 = __webpack_require__(54);
...
exports.ExamGrevianceModule = ExamGrevianceModule = __decorate([
    (0, common_1.Module)({
        imports: [prisma_1.PrismaModule],
        controllers: [exam_greviance_controller_1.ExamGrevianceController],
        providers: [exam_greviance_service_1.ExamGrevianceService],
    })
], ExamGrevianceModule);
...
let ExamGrevianceController = class ExamGrevianceController {
    constructor(examGrevianceService) {
        this.examGrevianceService = examGrevianceService;
    }
    async lookup(data) {
        try {
    ...
    async findOne(data) {
        try {
            return await this.examGrevianceService.findOne(Number(data.examGrevianceApplicationId));
        }
        catch (error) {
    ...
    async updateApplicationStatus(data) {
        try {
            return await this.examGrevianceService.updateApplicationStatus(Number(data.examGrevianceApplicationId), data.status, data.UpdatedBy, data.Remarks);
        }
        catch (error) {
            return {
                status: 'error',
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'lookup_exam_greviance_by_roll' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'create_exam_greviance' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGrevianceController.prototype, "findAll", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_one_exam_greviance' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGrevianceController.prototype, "findOne", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update_application_status_exam_greviance' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGrevianceController.prototype, "updateApplicationStatus", null);
exports.ExamGrevianceController = ExamGrevianceController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof exam_greviance_service_1.ExamGrevianceService !== "undefined" && exam_greviance_service_1.ExamGrevianceService) === "function" ? _a : Object])
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ExamGrevianceService = void 0;
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const FEE_BY_TYPE = [
...
let ExamGrevianceService = class ExamGrevianceService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async lookupByRoll(rollNoRaw) {
        ...
        if (!rollNo)
            throw new common_1.BadRequestException('Roll number is required');
        ...
        if (!results.length) {
            throw new common_1.NotFoundException(`No exam result found for roll number ${rollNo}. Please check and try again.`);
        }
    ...
    async create(data) {
        ...
        if (!rollNo)
            throw new common_1.BadRequestException('Roll number is required');
        const examResultIds = Array.isArray(data.examResultIds)
            ? data.examResultIds.map((id) => Number(id)).filter((id) => id > 0)
            : [];
        if (!examResultIds.length) {
            throw new common_1.BadRequestException('Select at least one paper');
        }
        ...
        if (!results.length) {
            throw new common_1.BadRequestException('Selected papers do not match this roll number');
        }
        const first = results[0];
    ...
    async findAll(filters = {}) {
        ...
        if (filters.grevianceTypeId)
            where.grevianceTypeId = Number(filters.grevianceTypeId);
    ...
    async findOne(examGrevianceApplicationId) {
        const row = await this.prisma.examGrevianceApplication.findFirst({
            where: { examGrevianceApplicationId, IsDeleted: false },
            include: { papers: true },
        });
        if (!row)
            throw new common_1.NotFoundException('Exam greviance application not found');
        return row;
    }
    async updateApplicationStatus(examGrevianceApplicationId, status, UpdatedBy, Remarks) {
        const nextStatus = String(status || '').trim().toUpperCase();
        if (!ALLOWED_STATUSES.includes(nextStatus)) {
            throw new common_1.BadRequestException(`Invalid status. Allowed: ${ALLOWED_STATUSES.join(', ')}`);
        }
        if (!UpdatedBy?.trim()) {
            throw new common_1.BadRequestException('UpdatedBy is required');
        }
...
exports.ExamGrevianceService = ExamGrevianceService;
exports.ExamGrevianceService = ExamGrevianceService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof prisma_1.PrismaService !== "undefined" && prisma_1.PrismaService) === "function" ? _a : Object])
], ExamGrevianceService);
...
const common_1 = __webpack_require__(5);
const state_module_1 = __webpack_require__(56);
const city_module_1 = __webpack_require__(60);
const program_category_module_1 = __webpack_require__(63);
const subject_module_1 = __webpack_require__(66);
const program_module_1 = __webpack_require__(69);
const board_module_1 = __webpack_require__(72);
const fee_type_module_1 = __webpack_require__(75);
const qualification_module_1 = __webpack_require__(78);
const admission_session_module_1 = __webpack_require__(81);
const academic_session_module_1 = __webpack_require__(84);
const program_fee_config_module_1 = __webpack_require__(87);
const college_module_1 = __webpack_require__(90);
const zipcode_module_1 = __webpack_require__(93);
const program_eligibility_module_1 = __webpack_require__(96);
const stream_module_1 = __webpack_require__(99);
const program_subject_module_1 = __webpack_require__(102);
const examination_details_module_1 = __webpack_require__(105);
const exam_scheme_module_1 = __webpack_require__(108);
const paper_type_module_1 = __webpack_require__(111);
const exam_type_module_1 = __webpack_require__(114);
const year_module_1 = __webpack_require__(117);
const semester_module_1 = __webpack_require__(120);
const paper_detail_module_1 = __webpack_require__(123);
...
exports.MasterModule = MasterModule = __decorate([
    (0, common_1.Module)({
        imports: [
            ...
            exam_greviance_price_module_1.ExamGreviancePriceModule,
            greviance_type_module_1.GrevianceTypeModule,
...
const common_1 = __webpack_require__(5);
const state_service_1 = __webpack_require__(57);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.isActiveOnly = isActiveOnly;
function isActiveOnly(value) {
...
const common_1 = __webpack_require__(5);
const city_service_1 = __webpack_require__(61);
const city_controller_1 = __webpack_require__(62);
const prisma_1 = __webpack_require__(6);
...
let CityService = class CityService {
    ...
    async findAll(stateId, activeOnly = false) {
...
const common_1 = __webpack_require__(5);
const program_category_service_1 = __webpack_require__(64);
const program_category_controller_1 = __webpack_require__(65);
const prisma_1 = __webpack_require__(6);
...
const common_1 = __webpack_require__(5);
const subject_service_1 = __webpack_require__(67);
...
let SubjectService = class SubjectService {
    ...
    async findAll(filters) {
        const whereClause = {
            IsDeleted: false,
            ...((0, active_only_1.isActiveOnly)(filters?.activeOnly) ? { IsActive: true } : {}),
        };
...
const common_1 = __webpack_require__(5);
const program_controller_1 = __webpack_require__(70);
const program_service_1 = __webpack_require__(71);
...
let ProgramController = class ProgramController {
    ...
    async findAll(data) {
        try {
            return await this.programService.findAll(data?.categoryId, data?.activeOnly);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
...
const common_1 = __webpack_require__(5);
const board_controller_1 = __webpack_require__(73);
const board_service_1 = __webpack_require__(74);
...
const common_1 = __webpack_require__(5);
const fee_type_controller_1 = __webpack_require__(76);
const fee_type_service_1 = __webpack_require__(77);
...
const qualification_service_1 = __webpack_require__(80);
...
const common_1 = __webpack_require__(5);
const admission_session_controller_1 = __webpack_require__(82);
const admission_session_service_1 = __webpack_require__(83);
...
const common_1 = __webpack_require__(5);
const academic_session_service_1 = __webpack_require__(85);
const academic_session_controller_1 = __webpack_require__(86);
const prisma_1 = __webpack_require__(6);
...
const common_1 = __webpack_require__(5);
const program_fee_config_controller_1 = __webpack_require__(88);
const program_fee_config_service_1 = __webpack_require__(89);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const college_controller_1 = __webpack_require__(91);
const college_service_1 = __webpack_require__(92);
...
const common_1 = __webpack_require__(5);
const zipcode_service_1 = __webpack_require__(94);
const zipcode_controller_1 = __webpack_require__(95);
const prisma_1 = __webpack_require__(6);
...
const common_1 = __webpack_require__(5);
const program_eligibility_service_1 = __webpack_require__(97);
const program_eligibility_controller_1 = __webpack_require__(98);
const prisma_1 = __webpack_require__(6);
    ...
    async validate(payload) {
        ...
        for (const rule of rules) {
            ...
            if (rule.ruleType === 'MIN_PERCENT') {
                ...
                if (ruleKey === 'SPORT_CERT' && !hasSportCertificate)
                    continue;
                if (ruleKey === 'NO_SPORT_CERT' && hasSportCertificate)
                    continue;
...
const common_1 = __webpack_require__(5);
const stream_service_1 = __webpack_require__(100);
const stream_controller_1 = __webpack_require__(101);
const prisma_1 = __webpack_require__(6);
...
let StreamService = class StreamService {
    ...
    async findAll(programId, activeOnly = false) {
...
const common_1 = __webpack_require__(5);
const program_subject_service_1 = __webpack_require__(103);
const program_subject_controller_1 = __webpack_require__(104);
const prisma_1 = __webpack_require__(6);
...
const common_1 = __webpack_require__(5);
const examination_details_service_1 = __webpack_require__(106);
const examination_details_controller_1 = __webpack_require__(107);
const prisma_1 = __webpack_require__(6);
...
let ExaminationDetailsService = class ExaminationDetailsService {
    ...
    async findAll(academicId, activeOnly = false) {
...
const common_1 = __webpack_require__(5);
const exam_scheme_controller_1 = __webpack_require__(109);
const exam_scheme_service_1 = __webpack_require__(110);
...
exports.ExamSchemeModule = ExamSchemeModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [exam_scheme_service_1.ExamSchemeService],
        exports: [exam_scheme_service_1.ExamSchemeService],
    })
], ExamSchemeModule);
...
let ExamSchemeController = class ExamSchemeController {
    ...
    async updateStatus(data) {
        try {
            return await this.examSchemeService.updateStatus(data.examSchemeId, data.IsActive, data.UpdatedBy);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
    ...
    async remove(data) {
        try {
            return await this.examSchemeService.remove(data.examSchemeId, data.DeletedBy, data.DeletedRemarks);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'preview_exam_scheme' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'save_exam_scheme' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_all_exam_schemes' }),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], ExamSchemeController.prototype, "findAll", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_one_exam_scheme' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update_status_exam_scheme' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'delete_exam_scheme' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
...
exports.ExamSchemeController = ExamSchemeController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof exam_scheme_service_1.ExamSchemeService !== "undefined" && exam_scheme_service_1.ExamSchemeService) === "function" ? _a : Object])
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ExamSchemeService = void 0;
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
let ExamSchemeService = class ExamSchemeService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    examScheme() {
    ...
    examSchemePaper() {
        return this.prisma.examSchemePaper;
    }
    schemeInclude() {
        return {
            papers: {
    ...
    mapScheme(scheme) {
        ...
        return {
            ...scheme,
            pcShortName: scheme.programCategory?.pcShortName || scheme.pcShortName || null,
            papers: (scheme.papers || []).map((paper) => ({
                ...paper,
                examDate: this.toDateInput(paper.examDate),
            })),
        };
    ...
    async countStudentsByPaper(params) {
        ...
        for (const row of grouped) {
            if (row.paperId)
                counts.set(row.paperId, row._count.paperId);
        }
        return counts;
    }
    async preview(query) {
        ...
        if (!examinationDetailId || !programId || !yearId) {
            throw new common_1.BadRequestException('Examination, program and year are required');
        }
        const examination = await this.prisma.examinationDetails.findFirst({
            where: { examinationId: examinationDetailId, IsDeleted: false },
            include: { academicSession: true },
        ...
        const savedByPaperId = new Map((existing?.papers || [])
            .filter((p) => p.paperId)
            .map((p) => [Number(p.paperId), p]));
        ...
        const rows = papers.map((paper, index) => {
            ...
            const paperNameWithCode = saved?.paperNameWithCode || this.paperLabel(paper.paperCode, paper.paperName);
            return {
    ...
    async save(data) {
        ...
        if (!papers.length) {
            throw new common_1.BadRequestException('At least one paper is required');
        }
        const examination = await this.prisma.examinationDetails.findFirst({
            where: { examinationId: examinationDetailId, IsDeleted: false },
            include: { academicSession: true },
        ...
        const existingByPaperId = new Map((existing?.papers || [])
            .filter((p) => p.paperId)
            .map((p) => [Number(p.paperId), p]));
        const keptIds = [];
        for (const [index, row] of papers.entries()) {
            ...
            const payload = {
                ...
                paperName,
                paperCode,
                paperNameWithCode: row.paperNameWithCode || this.paperLabel(paperCode, paperName),
                paperTypeId: row.paperTypeId || master?.paperTypeId || null,
                paperType: row.paperType || master?.paperTypeRelation?.name || master?.paperType || null,
    ...
    async remove(examSchemeId, DeletedBy, DeletedRemarks) {
        const row = await this.examScheme().findFirst({
            where: { examSchemeId, IsDeleted: false },
        });
        if (!row)
...
exports.ExamSchemeService = ExamSchemeService;
exports.ExamSchemeService = ExamSchemeService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof prisma_1.PrismaService !== "undefined" && prisma_1.PrismaService) === "function" ? _a : Object])
], ExamSchemeService);
...
const common_1 = __webpack_require__(5);
const paper_type_controller_1 = __webpack_require__(112);
const paper_type_service_1 = __webpack_require__(113);
...
const common_1 = __webpack_require__(5);
const exam_type_controller_1 = __webpack_require__(115);
const exam_type_service_1 = __webpack_require__(116);
...
const common_1 = __webpack_require__(5);
const year_controller_1 = __webpack_require__(118);
const year_service_1 = __webpack_require__(119);
...
const common_1 = __webpack_require__(5);
const semester_controller_1 = __webpack_require__(121);
const semester_service_1 = __webpack_require__(122);
...
const common_1 = __webpack_require__(5);
const paper_detail_controller_1 = __webpack_require__(124);
const paper_detail_service_1 = __webpack_require__(125);
...
let PaperDetailService = class PaperDetailService {
    ...
    paperDb() {
        return this.prisma.paperDetailMaster;
    }
    getIncludeRelations() {
        return {
...
const common_1 = __webpack_require__(5);
const exam_subject_controller_1 = __webpack_require__(127);
const exam_subject_service_1 = __webpack_require__(128);
...
const common_1 = __webpack_require__(5);
const role_controller_1 = __webpack_require__(130);
const role_service_1 = __webpack_require__(131);
...
const common_1 = __webpack_require__(5);
const marks_type_controller_1 = __webpack_require__(133);
const marks_type_service_1 = __webpack_require__(134);
let MarksTypeModule = class MarksTypeModule {
};
exports.MarksTypeModule = MarksTypeModule;
exports.MarksTypeModule = MarksTypeModule = __decorate([
    (0, common_1.Module)({
        controllers: [marks_type_controller_1.MarksTypeController],
        providers: [marks_type_service_1.MarksTypeService],
        exports: [marks_type_service_1.MarksTypeService],
    })
], MarksTypeModule);
...
let MarksTypeController = class MarksTypeController {
    ...
    async softDelete(data) {
        try {
            return await this.marksTypeService.softDelete(data.marksTypeId, data.DeletedBy, data.DeletedRemarks);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
...
exports.MarksTypeController = MarksTypeController;
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'create_marks_type' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], MarksTypeController.prototype, "create", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_all_marks_types' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], MarksTypeController.prototype, "findAll", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_one_marks_type' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], MarksTypeController.prototype, "findOne", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update_marks_type' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], MarksTypeController.prototype, "update", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'delete_marks_type' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], MarksTypeController.prototype, "softDelete", null);
exports.MarksTypeController = MarksTypeController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof marks_type_service_1.MarksTypeService !== "undefined" && marks_type_service_1.MarksTypeService) === "function" ? _a : Object])
], MarksTypeController);
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MarksTypeService = void 0;
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const active_only_1 = __webpack_require__(58);
let MarksTypeService = class MarksTypeService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(data) {
        ...
        if (existingName) {
            throw new common_1.ConflictException('Marks type name already exists');
        }
    ...
    async softDelete(marksTypeId, DeletedBy, DeletedRemarks) {
        await this.findOne(marksTypeId);
        return this.prisma.marksTypeMaster.update({
            where: { marksTypeId },
            data: {
...
exports.MarksTypeService = MarksTypeService;
exports.MarksTypeService = MarksTypeService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof prisma_1.PrismaService !== "undefined" && prisma_1.PrismaService) === "function" ? _a : Object])
], MarksTypeService);
...
let ExamGreviancePriceController = class ExamGreviancePriceController {
    ...
    async updateStatus(data) {
        try {
            return await this.greviancePriceService.updateStatus(data.examGreviancePriceMasterId, data.IsActive, data.UpdatedBy);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
    ...
    async softDelete(data) {
        try {
            return await this.greviancePriceService.softDelete(data.examGreviancePriceMasterId, data.DeletedBy, data.DeletedRemarks);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
    ...
    async bulkSoftDelete(data) {
        try {
            return await this.greviancePriceService.bulkSoftDelete(data.ids, data.DeletedBy, data.DeletedRemarks);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
...
exports.ExamGreviancePriceController = ExamGreviancePriceController;
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'create_exam_greviance_price' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGreviancePriceController.prototype, "create", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_all_exam_greviance_prices' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGreviancePriceController.prototype, "findAll", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_one_exam_greviance_price' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGreviancePriceController.prototype, "findOne", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update_exam_greviance_price' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGreviancePriceController.prototype, "update", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update_status_exam_greviance_price' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGreviancePriceController.prototype, "updateStatus", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'delete_exam_greviance_price' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGreviancePriceController.prototype, "softDelete", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'bulk_delete_exam_greviance_prices' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], ExamGreviancePriceController.prototype, "bulkSoftDelete", null);
exports.ExamGreviancePriceController = ExamGreviancePriceController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof exam_greviance_price_service_1.ExamGreviancePriceMasterService !== "undefined" && exam_greviance_price_service_1.ExamGreviancePriceMasterService) === "function" ? _a : Object])
], ExamGreviancePriceController);
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.ExamGreviancePriceMasterService = void 0;
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const active_only_1 = __webpack_require__(58);
function calculateFinalFee(base, pgRate = 2.0, gstRate = 18.0) {
...
let ExamGreviancePriceMasterService = class ExamGreviancePriceMasterService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    ...
    async findOne(examGreviancePriceMasterId) {
        ...
        if (!row) {
            throw new common_1.NotFoundException(`Exam Grievance Price with ID ${examGreviancePriceMasterId} not found`);
        }
        return row;
    }
    ...
    async updateStatus(examGreviancePriceMasterId, IsActive, UpdatedBy) {
    ...
    async softDelete(examGreviancePriceMasterId, DeletedBy, DeletedRemarks) {
        await this.findOne(examGreviancePriceMasterId);
        return this.prisma.examGreviancePriceMaster.update({
            where: { examGreviancePriceMasterId },
            data: {
...
exports.ExamGreviancePriceMasterService = ExamGreviancePriceMasterService;
exports.ExamGreviancePriceMasterService = ExamGreviancePriceMasterService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof prisma_1.PrismaService !== "undefined" && prisma_1.PrismaService) === "function" ? _a : Object])
], ExamGreviancePriceMasterService);
...
exports.GrevianceTypeModule = GrevianceTypeModule = __decorate([
    (0, common_1.Module)({
        controllers: [greviance_type_controller_1.GrevianceTypeController],
        providers: [greviance_type_service_1.GrevianceTypeService],
    })
], GrevianceTypeModule);
...
let GrevianceTypeController = class GrevianceTypeController {
    ...
    async updateStatus(data) {
        try {
            return await this.grevianceTypeService.updateStatus(data.grevianceTypeId, data.IsActive, data.UpdatedBy);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
    ...
    async softDelete(data) {
        try {
            return await this.grevianceTypeService.softDelete(data.grevianceTypeId, data.DeletedBy, data.DeletedRemarks);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
    ...
    async bulkSoftDelete(data) {
        try {
            return await this.grevianceTypeService.bulkSoftDelete(data.ids, data.DeletedBy, data.DeletedRemarks);
        }
        catch (error) {
            return { status: 'error', message: error.message || 'Unknown error' };
        }
...
exports.GrevianceTypeController = GrevianceTypeController;
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'create_greviance_type' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], GrevianceTypeController.prototype, "create", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_all_greviance_types' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], GrevianceTypeController.prototype, "findAll", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'find_one_greviance_type' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], GrevianceTypeController.prototype, "findOne", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update_greviance_type' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], GrevianceTypeController.prototype, "update", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'update_status_greviance_type' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], GrevianceTypeController.prototype, "updateStatus", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'delete_greviance_type' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], GrevianceTypeController.prototype, "softDelete", null);
__decorate([
    (0, microservices_1.MessagePattern)({ cmd: 'bulk_delete_greviance_types' }),
    __param(0, (0, microservices_1.Payload)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], GrevianceTypeController.prototype, "bulkSoftDelete", null);
exports.GrevianceTypeController = GrevianceTypeController = __decorate([
    (0, common_1.Controller)(),
    __metadata("design:paramtypes", [typeof (_a = typeof greviance_type_service_1.GrevianceTypeService !== "undefined" && greviance_type_service_1.GrevianceTypeService) === "function" ? _a : Object])
], GrevianceTypeController);
...
var _a;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.GrevianceTypeService = void 0;
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const active_only_1 = __webpack_require__(58);
let GrevianceTypeService = class GrevianceTypeService {
    constructor(prisma) {
        this.prisma = prisma;
    }
    async create(data) {
    ...
    async findOne(grevianceTypeId) {
        const row = await this.prisma.grevianceTypeMaster.findFirst({
            where: { grevianceTypeId, IsDeleted: false },
        });
        if (!row) {
            throw new common_1.NotFoundException(`Greviance type with ID ${grevianceTypeId} not found`);
        }
        return row;
    }
    async update(grevianceTypeId, data) {
    ...
    async updateStatus(grevianceTypeId, IsActive, UpdatedBy) {
        await this.findOne(grevianceTypeId);
        return this.prisma.grevianceTypeMaster.update({
            where: { grevianceTypeId },
            data: { IsActive, UpdatedBy },
    ...
    async softDelete(grevianceTypeId, DeletedBy, DeletedRemarks) {
        await this.findOne(grevianceTypeId);
        return this.prisma.grevianceTypeMaster.update({
            where: { grevianceTypeId },
            data: {
...
exports.GrevianceTypeService = GrevianceTypeService;
exports.GrevianceTypeService = GrevianceTypeService = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [typeof (_a = typeof prisma_1.PrismaService !== "undefined" && prisma_1.PrismaService) === "function" ? _a : Object])
], GrevianceTypeService);
...
const common_1 = __webpack_require__(5);
const campus_quick_link_module_1 = __webpack_require__(142);
const latest_update_module_1 = __webpack_require__(145);
const admission_enquiry_module_1 = __webpack_require__(148);
const hero_section_module_1 = __webpack_require__(151);
const notice_board_module_1 = __webpack_require__(154);
const accreditation_slider_module_1 = __webpack_require__(157);
const top_achiever_module_1 = __webpack_require__(160);
const image_gallery_module_1 = __webpack_require__(163);
const video_gallery_module_1 = __webpack_require__(166);
const contact_enquiry_module_1 = __webpack_require__(169);
const stats_counter_module_1 = __webpack_require__(172);
const testimonial_module_1 = __webpack_require__(175);
const header_button_module_1 = __webpack_require__(178);
const committee_module_1 = __webpack_require__(181);
const committee_submenu_module_1 = __webpack_require__(184);
const examiner_registration_module_1 = __webpack_require__(187);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const campus_quick_link_controller_1 = __webpack_require__(143);
const campus_quick_link_service_1 = __webpack_require__(144);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const latest_update_controller_1 = __webpack_require__(146);
const latest_update_service_1 = __webpack_require__(147);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const admission_enquiry_controller_1 = __webpack_require__(149);
const admission_enquiry_service_1 = __webpack_require__(150);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const hero_section_controller_1 = __webpack_require__(152);
const hero_section_service_1 = __webpack_require__(153);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const notice_board_controller_1 = __webpack_require__(155);
const notice_board_service_1 = __webpack_require__(156);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const accreditation_slider_controller_1 = __webpack_require__(158);
const accreditation_slider_service_1 = __webpack_require__(159);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const top_achiever_controller_1 = __webpack_require__(161);
const top_achiever_service_1 = __webpack_require__(162);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const image_gallery_controller_1 = __webpack_require__(164);
const image_gallery_service_1 = __webpack_require__(165);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const video_gallery_controller_1 = __webpack_require__(167);
const video_gallery_service_1 = __webpack_require__(168);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const contact_enquiry_controller_1 = __webpack_require__(170);
const contact_enquiry_service_1 = __webpack_require__(171);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const stats_counter_controller_1 = __webpack_require__(173);
const stats_counter_service_1 = __webpack_require__(174);
...
const common_1 = __webpack_require__(5);
const prisma_1 = __webpack_require__(6);
const testimonial_controller_1 = __webpack_require__(176);
const testimonial_service_1 = __webpack_require__(177);
...
const common_1 = __webpack_require__(5);
const header_button_controller_1 = __webpack_require__(179);
const header_button_service_1 = __webpack_require__(180);
...
const common_1 = __webpack_require__(5);
const committee_controller_1 = __webpack_require__(182);
const committee_service_1 = __webpack_require__(183);
...
const common_1 = __webpack_require__(5);
const committee_submenu_controller_1 = __webpack_require__(185);
const committee_submenu_service_1 = __webpack_require__(186);
...
const common_1 = __webpack_require__(5);
const examiner_registration_controller_1 = __webpack_require__(188);
const examiner_registration_service_1 = __webpack_require__(189);
...
const common_1 = __webpack_require__(5);
const admin_login_module_1 = __webpack_require__(191);
...
const common_1 = __webpack_require__(5);
const jwt_1 = __webpack_require__(12);
const admin_login_controller_1 = __webpack_require__(192);
const admin_login_service_1 = __webpack_require__(193);
