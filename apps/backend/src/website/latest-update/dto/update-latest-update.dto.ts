...
export class UpdateLatestUpdateDto {
  @ApiProperty({ example: 'Admissions Open 2026-27', description: 'Title of the update', required: false })
  @IsString()
  @IsOptional()
  title?: string;
  ...
  @ApiProperty({ example: true, description: 'Is update entry active?', required: false })
  @IsBoolean()
  @IsOptional()
  IsActive?: boolean;

  @ApiProperty({ example: 'Updated announcement details', description: 'Optional remarks', required: false })
  @IsString()
  @IsOptional()
  Remarks?: string;
}
