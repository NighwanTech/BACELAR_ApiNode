...
export class CreateAttendanceDaysDto {
  ...
  @ApiProperty({ example: 22, description: 'Total Present Days', required: false })
  @IsInt()
  @IsOptional()
  presentDays?: number;

  @ApiProperty({ example: 88.0, description: 'Total Attendance Percentage (Calculated automatically if omitted)', required: false })
  @IsNumber()
  @IsOptional()
  totalAttendancePercentage?: number;

  @ApiProperty({ example: 'Admin User', description: 'Created By User Name', required: false })
  @IsString()
  @IsOptional()
  CreatedBy?: string;
  ...
  @ApiProperty({ example: 'Monthly attendance record', description: 'Remarks', required: false })
  @IsString()
  @IsOptional()
  Remarks?: string;
}
