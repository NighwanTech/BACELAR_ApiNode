...
export class UpdateExaminerRegistrationDto {
  ...
  @ApiProperty({ example: 'Dr. Rajesh Kumar', description: 'Full Name of the Examiner', required: false })
  @IsString()
  @IsOptional()
  fullName?: string;
  ...
  @ApiProperty({ example: '9876543210', description: 'Primary Mobile Number', required: false })
  @IsString()
  @IsOptional()
  mobileNo?: string;
  ...
  @ApiProperty({ example: 'Professor', description: 'Designation', required: false })
  @IsString()
  @IsOptional()
  designation?: string;
  ...
  @ApiProperty({ example: '15 Years', description: 'Teaching Experience', required: false })
  @IsString()
  @IsOptional()
  ...
  @ApiProperty({ example: 'Updated designation and teaching experience', description: 'Optional remarks', required: false })
  @IsString()
  @IsOptional()
  Remarks?: string;
}
